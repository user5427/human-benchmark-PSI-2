...
may be useful to show the actual binary files that are deployed. Artifacts can
FIGURE 21–1 E XAMPLE OF A R UNTIME P LATFORM M ODEL
...
mented with textual descriptions for each of the major elements.
384
 P A R T III  A V I E W P O I N T C A T A L O G
NOTATION Common notations used for capturing the network model include
...
environment.
P ROBLEMSFIGURE 21–3 M ODELS IN D EPLOYMENT V IEW
AND P ITFALLS
