...
This section will discuss the stakeholder needs \ref{sec:stakeholders_needs} and requirements of the system.
Needs that impact the bussiness the most will be listed and discussed.
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|}
        ...
        \hline
        SR1 & User registration & Users should be able to register an account. \\
        \hline
