...
\begin{itemize}
    ...
    \item Section \ref{sec:bpmn_uml_use_cases} will focus on BPMN diagrams, use cases of the system and UML diagrams.
    \item Section 3 will focus on improvements that can be made to the system.
    \item Section 4 will -.
