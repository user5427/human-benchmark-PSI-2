...
\begin{itemize}
    ...
    \item \textbf{Component diagram} - this diagram models the components and their relationships in the system.
    \item \textbf{Deployment diagram} - this diagram models the deployment of the system components.
    \item \textbf{State diagram} - this diagram models the states of the system components.
    \item \textbf{Activity diagram} - this diagram models the activities and their relationships in the system.
    \item \textbf{Use case diagram} - this diagram models the use cases of the system.
    \begin{figure}[H]
        \centering
