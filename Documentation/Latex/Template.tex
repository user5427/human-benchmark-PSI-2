...
This work documents the Human Benchmark system.
...
\subsection{System and bussiness overview}
...
\end{itemize}
\subsubsubsection{Opportunities}
\begin{itemize}
...
\subsubsection{Porter's Methods, Base needs and additional value}

\subsubsubsection{Porter\'s Methods}
\begin{itemize}
...
\subsubsubsection{Additional Value}

TODO WHEN WE CHOOSE WHAT TO DEVELOP

\subsection{Bussiness and system boundaries}
\label{sec:bussiness_boundaries}

\subsubsection{Input and Output Analysis}
...
\begin{itemize}
    \item \textbf{Class diagram} - \ref{fig:class_diagram} diagram models the classes and relationships of the system.
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{images/UML-all.png}
        \caption{Class diagram}
        \label{fig:class_diagram}
    \end{figure}
    % \begin{figure}[H]
    %     \centering
    %     \includegraphics[width=0.5\textwidth]{images/UML-noDependen.png}
    %     \caption{Class diagram with no dependencies (for better readability)}
    %     \label{fig:class_diagram_no_dependencies}
    % \end{figure}
