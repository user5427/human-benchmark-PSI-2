...
\textbf{Keywords:} Human Benchmark, SWOT, MOST, SMART, BPMN, UML.
...
\begin{itemize}
    \item Section \ref{sec:system_overview} will provide an overview of the system and its bussiness logic.
    \item Section \ref{sec:bussiness_boundaries} will focus on the bussiness and system boundaries.
    \item Section \ref{sec:bpmn_uml_use_cases} will focus on BPMN diagrams and UML diagrams.
    \item Section \ref{sec:requirements} will focus on user needs and requirements.
    \item Section \ref{sec:results} - short summary of the results and discussion.
    \item Section \ref{sec:conclusion} - conclusions of lab 1.
\end{itemize}
...
People manage to faster process information which can greatly benefit them in daily life.
...
Similar to Kearney, we found that video games can stimulate your mind and benefit people’s cognitive skills. 
In a prior study, Klicka measured the effect of video games on college football players. He found that 
video gamers had faster reaction times and therefore may improve hand-eye coordination for a person. This 
relates to our study because, in our
experiment, the gaming group had significantly faster scores than the non-gaming group which supports my hypothesis. This 
suggests games might play a role in reaction time. \cite{ReactionTime}

\subsection{MOST analysis}
MOST analysis is a strategic planning technique used to help a person or organization identify mission, objectives, strategies, and tactics related to business competition or project planning. It is intended to specify the objectives of the business venture or project and identify the internal and external factors that are favorable and unfavorable to achieving those objectives.

\subsubsection{Mission}
\begin{itemize}
    \item Users improve their reaction speed and reflexes through games.
\end{itemize}

\subsubsection{Objectives}
\begin{itemize}
    \item Provide a user-friendly web app.
    \item Make training fun and non-repetitive.
    \item Use social, competitive aspect to motivate players.
    \item Make it accessible for users of different skill levels.
    \item Enable users to track and visualize their progress over time.
\end{itemize}

\subsubsection{Strategies}
\begin{itemize}
    \item Simple and minimal UI to keep users focused on gameplay.
    \item Multiple game modes with adjustable difficulty.
    \item Leaderboards to encourage competition and comparison with others.
    \item Point system \& each attempt tracking to display progress over time.
\end{itemize}

\subsubsection{Tactics}
\begin{itemize} 
    \item Minimal color palette.
    \item Responsive, lightweight UI to minimize input lag.
    \item Customizable game settings for non-competitive modes.
    \item Personalized statistics dashboard displaying average, best scores, progress.
\end{itemize}
