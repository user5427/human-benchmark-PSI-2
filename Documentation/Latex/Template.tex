...
\subsubsubsection{Mission}
\begin{itemize}
    \item Provide an engaging and competitive app for users to measure, track, and improve their reaction speed.
    \item Users improve their reaction speed and reflexes through games.
    \item People manage to faster process information which can greatly benefit them in daily life.
\end{itemize}
