...
% Zref properties
% \zref@newprop{ReqId}{default_value}
...
\begin{itemize}
    ...
    \item Conclusions \ref{sec:conclusion} - conclusions of lab \ref{sec:lab_1}.
\end{itemize}
