...
\begin{itemize}
    ...
    \item Results and discussion \ref{sec:results} - short summary of the results and discussion.
    \item Conclusions \ref{sec:conclusion} - conclusions of lab 1.
\end{itemize}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|}
        ...
        \hline
        \zref{stakeholder:1} & User registration & Users should be able to register an account. \\
        \hline
        SR2 & User login & Users should be able to log in to their account. \\
        \hline
        SR3 & Game creation & Users should be able to create a new game. \\
        \hline
        SR4 & Leaderboard & Users should be able to view the leaderboard. \\
        \hline
        SR5 & Game play & Users should be able to play games. \\
        \hline
    \end{tabular}
    \caption{User needs and requirements}
...
\begin{itemize}
    \item 
    \zlabel{stakeholder:1}\zrefused{stakeholder:1}{SR1}
    \textbf{Fix the STOP button} in the Reflex Test.
    
    \item 
    \zlabel{stakeholder:2}\zrefused{stakeholder:2}{SR2}
    Adjust \textbf{game creation parameters} based on the game type (currently, all parameters are the same, including unnecessary ones).
    
    \item 
    \zlabel{stakeholder:3}\zrefused{stakeholder:3}{SR3}
    Optimize \textbf{screen size handling} in games (Reflex Test is too easy to play on mobile devices).
    
    \item 
    \zlabel{stakeholder:4}\zrefused{stakeholder:4}{SR4}
    Prevent scores from being submitted \textbf{before the game ends} (currently, random data can be entered via Swagger).
    
    \item 
    \zlabel{stakeholder:5}\zrefused{stakeholder:5}{SR5}
    Allow users to \textbf{change the game image}.
    
    \item 
    \zlabel{stakeholder:6}\zrefused{stakeholder:6}{SR6}
    Implement \textbf{private games} (currently, others' created games can override yours).
    
    \item 
    \zlabel{stakeholder:7}\zrefused{stakeholder:7}{SR7}
    Add a \textbf{Moving Targets} game.
    
    \item 
    \zlabel{stakeholder:8}\zrefused{stakeholder:8}{SR8}
    Enable players to \textbf{view their achievements} (high scores).
    
    \item 
    \zlabel{stakeholder:9}\zrefused{stakeholder:9}{SR9}
    Add a \textbf{game history} for previously played games.
    
    \item 
    \zlabel{stakeholder:10}\zrefused{stakeholder:10}{SR10}
    Provide \textbf{more information} about the games.
    
    \item 
    \zlabel{stakeholder:11}\zrefused{stakeholder:11}{SR11}
    Implement a \textbf{light/dark theme} toggle.
    
    \item 
    \zlabel{stakeholder:12}\zrefused{stakeholder:12}{SR12}
    Improve \textbf{sound design and VFX} for Reflex Test and Moving Targets.
    
    \item 
    \zlabel{stakeholder:13}\zrefused{stakeholder:13}{SR13}
    Adjust \textbf{Reflex Test scoring} based on click speed and accuracy.
    
    \item 
    \zlabel{stakeholder:14}\zrefused{stakeholder:14}{SR14}
    Create \textbf{different Reflex Test variations}:
    \begin{itemize}
        \item 
        \zlabel{stakeholder:15}\zrefused{stakeholder:15}{SR15}
        One where you play until missing a certain number of targets.
        
        \item 
        \zlabel{stakeholder:16}\zrefused{stakeholder:16}{SR16}
        Another with a \textbf{fixed number of targets}.
    \end{itemize}
    
    \item 
    \zlabel{stakeholder:17}\zrefused{stakeholder:17}{SR17}
    Enhance the \textbf{leaderboard UI} and expand functionality for different game variations.
    
    \item 
    \zlabel{stakeholder:18}\zrefused{stakeholder:18}{SR18}
    Allow users to view the \textbf{top 10/top 20 players} for each game separately.
    
    \item 
    \zlabel{stakeholder:19}\zrefused{stakeholder:19}{SR19}
    Implement a \textbf{rating system} for user-created games—highly rated/popular games should be displayed higher in the list.
\end{itemize}
